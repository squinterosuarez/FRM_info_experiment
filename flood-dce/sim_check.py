...
mu=dict(asc=-0.40,a1e1=0.50,a1e2=0.00,a1e3=0.40,a2e1=0.30,a2e2=0.00,a3e1=-0.20,a3e2=0.40,a4e1=0.50,cost=-0.80)
dt=dict(asc=-0.05,**{k:0 for k in mu if k!='asc'})
up=dict(asc=-0.15,a1e1=-0.10,a1e2=0.20,a1e3=0.00,a2e1=0.15,a2e2=0.00,a3e1=0.20,a3e2=0.10,a4e1=0.15,cost=0)
dn=dict(asc=0.20,a1e1=-0.20,a1e2=-0.05,a1e3=0.00,a2e1=-0.15,a2e2=0.00,a3e1=-0.15,a3e2=-0.10,a4e1=0.00,cost=0)
NP_ASC=-0.10
sd=dict(asc=1.0,a1e1=0.5,a1e2=0.5,a1e3=0.4,a2e1=0.4,a2e2=0.3,a3e1=0.4,a3e2=0.4,a4e1=0.4)
...
def alt():
    return dict(a1=rng.integers(1,5,24),a2=rng.integers(1,4,24),a3=rng.integers(1,4,24),
...
def a2pw(l,b):return b['a2e1'] if l==1 else b['a2e2'] if l==2 else -(b['a2e1']+b['a2e2'])
