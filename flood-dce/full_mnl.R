## full_mnl.R — fixed-coefficient conditional logit on the full sample (N=1043), by
## prior-gap category. Fixed-coef spec: fast, interpretable part-worths per group.
