## attr_shifts.R — conditional ITTs on ALL policy attributes (targeting, national
## funding, flat cost-sharing, effectiveness), by prior-gap category. Truth from
...
for (a in c("targeting","national","flat","effective")) {
